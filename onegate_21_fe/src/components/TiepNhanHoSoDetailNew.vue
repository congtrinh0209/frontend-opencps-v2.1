  ...
  <div>
        ...
        <div v-else>
          <v-card flat color="#fff">
            ...
            <v-form ref="formTiepNhan" lazy-validation>
              <thu-tuc-cap-ho-chieu-ngoai-giao-cong-vu v-if="data_form_template === 'formCH'" ref="hochieungoaigiaocongvu" :quyenTraCuuLgsp="quyenTraCuuLgsp" @showDialogSearchLgspCongDanEmit="showDialogSearchLgspCongDan" :formCode="formCode" :id="id" @changeCheckCKCD="changeCheckCKCD"></thu-tuc-cap-ho-chieu-ngoai-giao-cong-vu>
              <thu-tuc-hop-phap-hoa-lanh-su v-if="data_form_template === 'formHPH'" ref="thutuchopphaphoa" :quyenTraCuuLgsp="quyenTraCuuLgsp" @showDialogSearchLgspCongDanEmit="showDialogSearchLgspCongDan"  :formCode="formCode" :id="id" @changeCheckCKCD="changeCheckCKCD" @changeCheckGiayTo="changeCheckGiayTo"></thu-tuc-hop-phap-hoa-lanh-su>
              ...
              <thu-tuc-cap-thi-thuc v-if="data_form_template === 'formTT'" ref="thithuc" :quyenTraCuuLgsp="quyenTraCuuLgsp" @showDialogSearchLgspCongDanEmit="showDialogSearchLgspCongDan"  :formCode="formCode" :id="id" @changeCheckCKCD="changeCheckCKCD"></thu-tuc-cap-thi-thuc>
            </v-form>
          </v-card>
          <!--  -->
    ...
    <v-dialog v-model="dialog_searchLgsp" scrollable persistent max-width="1000px">
      <v-card>
        ...
        <tra-cuu-csdldc ref="tracuuCsdldc" :applicantIdNoProps="applicantIdNoLgsp" :applicantNameProps="applicantNameLgsp"></tra-cuu-csdldc>
      </v-card>
    </v-dialog>
  </div>
</template>
...
import TraCuuCSDLDC from './TiepNhan/TraCuuCSDLDC.vue'
...
export default {
  ...
  watch: {
    ...
    activeBindApplicantLgsp (val) {
      this.dialog_searchLgsp = false
    }
  },
  methods: {
    onResize () {
    ...
    formVue (data) {
      ...
      if (vm.doAction && vm.dataDetailAction.preCondition.split(',').includes("ALLOW_SUBMIT_FORM=0")) {
        activeDoAction('goBack')
      } else {
