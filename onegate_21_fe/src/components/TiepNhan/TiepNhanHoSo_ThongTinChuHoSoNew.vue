          ...
          <v-expansion-panel :value="[true]" expand  class="expansion-pl">
            <v-expansion-panel-content>
              <div slot="header"> 
                ...
                <span class="text-bold">Thông tin người nộp hồ sơ</span> 
              </div>
              <v-card>
                <v-card-text>
                  ...
                  <v-layout wrap v-else-if="delegateType === 2">
                    ...
                    <v-flex xs12 sm4>
                      ...
                      <v-text-field
                      v-else
                      v-model="thongTinNguoiNopHoSo.documentNo"
                      ></v-text-field>
                    </v-flex>
                    <v-flex xs12 sm2>
                      <content-placeholders class="mt-1" v-if="loading">
                      ...
                      <v-subheader v-else class="pl-0">Ngày ban hành: </v-subheader>
                    </v-flex>
                    <v-flex xs12 sm4>
                      <content-placeholders class="mt-1" v-if="loading">
                        <content-placeholders-text :lines="1" />
                    ...
                    <v-flex xs12 sm2>
                      ...
                      <v-subheader v-else class="pl-0">Trích yếu nội dung: </v-subheader>
                    </v-flex>
                    <v-flex xs12 sm10>
                      <content-placeholders class="mt-1" v-if="loading">
                        <content-placeholders-text :lines="1" />
                    ...
                    <v-flex xs12 sm2>
                      ...
                      <v-subheader v-else class="pl-0">Cơ quan ban hành: </v-subheader>
                    </v-flex>
                    <v-flex xs12 sm10>
                      <content-placeholders class="mt-1" v-if="loading">
                        <content-placeholders-text :lines="1" />
        ...
        <div style="position: relative;" v-if="delegateType !== 0">
          <v-expansion-panel :value="[true]" expand  class="expansion-pl" v-if="!showApplicant">
            <v-expansion-panel-content>
              <div slot="header"> 
                <div class="background-triangle-small"> <v-icon size="18" color="white">star_rate</v-icon></div> 
                <span class="text-bold">Thông tin chủ hồ sơ</span>
              </div>
              <v-card>
          ...
          <div class="absolute__btn" style="width: 350px;" v-if="originality !== 1">
            ...
            <v-radio-group class="mt-2" v-else v-model="thongTinChuHoSo.userType" row @change="checkApplicantInfos">
              <v-radio :value="true"><template slot="label"><span class="black--text">Công dân</span></template></v-radio>
              <v-radio :value="false"><template slot="label"><span class="black--text">Tổ chức, doanh nghiệp</span></template></v-radio>
            </v-radio-group>
          </div>
